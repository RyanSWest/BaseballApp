...
const Player = ({ name, pos, team, id, hr, rbi, avg,   pic }) => {
  const key = id;
    ...
    >
      ...
      <Card.Footer>
        ...
        >
          ...
          <h6 class = 'card-text'>{pos}</h6>
          <h6 class="card-text">AVG: {avg}</h6>
          <h6 class="card-text">HR: {hr}</h6>
          <h6 class="card-text">RBI: {rbi}</h6>
        </Card.Text>
      </Card.Footer>
    </Card>
  );
